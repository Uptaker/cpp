...
int main(void) {
    ...
    for (int i = 0; i < 200; i++) {
        ...
        if (radiaatorSees && r2.getTemp() > 19) radiaatorSees = false;
        if (!radiaatorSees && r2.getTemp() < 18) radiaatorSees = true;

        // Pange termomeeter ilma radiaatorita tuppa, lülitage selle järgi ja vaadake tulemusi
